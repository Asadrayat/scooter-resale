...
const Achieve = () => {
    return (
        <div className="hero h-96 my-16 " style={{ backgroundImage: `url("https://i.ibb.co/614G7Wh/achieve.jpg")` }}>
            ...
            <div className="hero-content text-center text-neutral-content flex flex-col">
                <p className='text-5xl text-white font-bold'>What Have We Achieved</p>
                <div className='grid lg:grid-cols-4 gap-16'>
                    <div>
                        <div className='w-48 h-48 border-8 rounded-full border-blue-900 '>
                            <div ><GiScooter className='text-9xl lg:pl-6 '></GiScooter></div>
                    ...
                    <div>
                        <div className='w-48 h-48 border-8 rounded-full border-blue-900 '>
                            <div ><FaAward className='text-9xl lg:pl-10 lg:pt-4 '></FaAward></div>
                    ...
                    <div>
                        <div className='w-48 h-48 border-8 rounded-full border-blue-900 '>
                            <div ><BiHappyAlt className='text-9xl lg:pl-10 '></BiHappyAlt></div>
                    ...
                    <div>
                        <div className='w-48 h-48 border-8 rounded-full border-blue-900 '>
                            <div ><IoIosPeople className='text-9xl lg:pl-10 '></IoIosPeople></div>
