...
import scooter from '../../../assets/images/about.png';
const AdvertisedItem = () => {
    return (
        <div className="hero py-16">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <div>
                    <h1 className="text-5xl font-bold text-center text-blue-900">About Us</h1>
                ...
                <img src={scooter} className="rounded-lg lg:w-1/2 shadow-2xl" alt='' />
            </div>
        </div>
    );
};
